...
const fonts=["-apple-system", "BlinkMacSystemFont", "Segoe UI", "Roboto", "Helvetica Neue", "Arial", "Noto Sans", "Liberation Sans", "sans-serif", "'Audiowide', cursive",
"'Bangers', cursive",
"'Lobster', cursive",
"'Rochester', cursive",
"'Satisfy', cursive",
...
const Branding = () => {
    ...
    const [fontNumber, setFontNumber]=React.useState(fonts[getRandomInt(0,fonts.length)])
